...
if(isset($_POST['submit'])){
    $query = "UPDATE `emarsys_email_templates` SET ";
    $query .= "`store_name` = '" . trim($_SESSION['shop']) . "', ";
    $query .= "`templateTitle` = '" . $_POST['templateTitle'] . "', ";
    $query .= "`templateBody` = '" . $con->real_escape_string($_POST['templateBody']) . "'";
    $query .= " WHERE `pkTemplateID` = '" . $_GET['id'] . "'";
    $result = $con->query($query);
    if($result){
        header('Location: templates.php');
    }else {
	            ...
	            <div class="row">
                    <div class="col-lg-9">
                        <form role="form" method="POST">
                            <input type="hidden" value="<?= $row['pkTemplateID']?>" name="pkTemplateID">
                            <div class="form-group">
                                <label>Template Title</label>
                                <input class="form-control" name="templateTitle" value="<?= $row['templateTitle']?>">
