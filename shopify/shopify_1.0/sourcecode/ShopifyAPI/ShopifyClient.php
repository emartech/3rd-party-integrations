...
class ShopifyClient {
	...
	public function call($method, $path, $params=array())
	{
		...
		// add auth headers
		// $request_headers[] = 'Authorization: Bearer ' . $this->token; // Haravan Authen. 
		$request_headers[] = 'X-Shopify-Access-Token: ' . $this->token; // Shopify Authen.  
